...
# Create two clipping planes: one for the X axis and one for the Y axis
xPlane = vtk.vtkPlane()
...
# Add both clipping planes to the volume mapper
...
# Set up an implicit plane widget for the X plane
...
# Set up an implicit plane widget for the Y plane
